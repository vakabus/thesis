...
import numpy as np
import polars as pl
from parsing import normalize_ts, parse_icmp_rtt, parse_trace, parse_udp_rr, parse_usdt, parse_vswitchd, remove_offset_and_scale, renumber
...
trace_table, trace_cmd, trace_upcalls, trace_upcalls_filtered, vswitchd, udp_rtt_latencies, udp_rtt_dropped, icmp_lat, icmp_err, usdt_flow_limit, usdt_barriers, kernel_lock = normalize_ts(trace_table, trace_cmd, trace_upcalls, trace_upcalls_filtered, vswitchd, udp_rtt_latencies, udp_rtt_dropped, icmp_lat, icmp_err, usdt_flow_limit, usdt_barriers, kernel_lock)
...
# USDT barriers
usdt_barriers, = remove_offset_and_scale('tid', 1000, usdt_barriers)
ax.hlines(usdt_barriers['tid'] - 10_000, usdt_barriers['ts']-usdt_barriers['duration_sec'], usdt_barriers['ts'], label="revalidator sleep (y-value ~ tid)", color="black")
