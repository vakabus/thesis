...
./daemonset.sh --image=ghcr.io/ovn-org/ovn-kubernetes/ovn-kube-f:master --net-cidr=10.244.0.0/16 --svc-cidr=10.245.0.0/16 --gateway-mode="local" --k8s-apiserver=https://192.168.1.221:6443
popd
